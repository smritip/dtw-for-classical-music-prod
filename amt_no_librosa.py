...
from dsp.chroma_no_librosa import wav_to_chroma
...
amt = AutomaticMarkingTransfer('bso_files/test/4-27_crop.wav', 'bso_files/test/4-27_crop.mmd', 'bso_files/test/4-28_crop.wav', 'bso_files/test/4-28_crop_test.mmd')
